  ...
  render() {
    return (
      <div className="assignmentListsWrapper">
        ...
        <div className="assignmentLists flex gap-12 flex-wrap justify-between md:justify-around">
          <a
            className="assignmentCard w-76 rounded-lg bg-gray-50 cursor-pointer flex flex-col mx-auto"
            href="/technical-assessment-test/c-sharp"
            target="_blank"
            rel="noopener noreferrer"
          >
            <div className="header w-full max-h-full p-6 flex gap-3 relative">
              <img
                className="skill-icon flex w-12 h-12 p-1.5 justify-center items-center rounded bg-black object-contain"
                src="https://dersyb7nfifdf.cloudfront.net/production/17900/c2e406a6-b6eb-4c44-a1c0-147b326ec406.png"
                alt="C# (C-sharp)"
              />
              <div className="text text-lg font-semibold leading-6 max-w-xs">
                C# (C-sharp)
              </div>
            ...
            <div className="skillTagsContainer flex flex-wrap gap-3.5 p-0 px-5 pb-7">
              <div className="skillTag rounded-full bg-blue-100 p-1.5 px-4 flex items-center justify-center text-xs font-normal">
                C# Miscellaneous
              </div>
              <div className="skillTag rounded-full bg-blue-100 p-1.5 px-4 flex items-center justify-center text-xs font-normal">
                C# 6
            ...
            <div className="moreInfoWrapper flex flex-col gap-2.5 p-0 px-5 pb-7 mt-auto">
              <div>
                <span className="moreInfo bold font-bold">30 minutes</span>
                <span className="moreInfo text-sm font-normal"> duration</span>
              </div>
              <div>
                <span className="moreInfo bold font-bold">Medium</span>
                <span className="moreInfo text-sm font-normal"> difficulty level</span>
              </div>
              <div>
                <span className="moreInfo bold font-bold">25</span>
                <span className="moreInfo text-sm font-normal"> questions</span>
              </div>
              <div>
                <span className="moreInfo bold font-bold">Entry-level</span>
                <span className="moreInfo text-sm font-normal"> seniority level</span>
              </div>
              <div>
                <span className="moreInfo bold font-bold">627+</span>
                <span className="moreInfo text-sm font-normal"> candidates assessed</span>
              </div>
              <div>
